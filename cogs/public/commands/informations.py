...
class Informations(commands.Cog):
    ...
    async def variables(self, ctx : commands.Context):
        ...
        guild_embed.add_field(name = "`{MembersCount}`", value = f"*Exemple :* {len(ctx.guild.members)}")
        guild_embed.add_field(name = "`{HumansCount}`", value = f"*Exemple :* {len(ctx.guild.members) - bots}")
        guild_embed.add_field(name = "`{BotsCount}`", value = f"*Exemple :* {bots}")
