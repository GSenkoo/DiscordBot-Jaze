...
from menus.configuration.suggestions.ManageSuggestions import ManageSuggestions
from menus.configuration.suggestions.functions import get_suggestion_settings_embed, get_suggestions_data
...
class Configuration(commands.Cog):
    ...
    async def suggestions(self, ctx):
        suggestion_data = await get_suggestions_data(self.bot, ctx)
        await ctx.send(embed = await get_suggestion_settings_embed(self.bot, ctx, suggestion_data), view = ManageSuggestions(self.bot, ctx, suggestion_data))
